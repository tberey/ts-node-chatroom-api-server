...
export class ServerRouter extends Server {
    ...
    private getRequests():void {
        ...
        this.app.get('/chat', (req:Request,res:Response):void => req.session!.loggedin ? res.status(200).render('chatroom', {data: {username: req.session!.username,uid: req.session!.uid}}) : res.status(403).redirect('/'));
